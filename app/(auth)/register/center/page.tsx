...
export default function RegisterCenterPage() {
  const t = useTranslations("auth.registerCenter")
  ...
  async function handleGoogle() {
    ...
    await supabase.auth.signInWithOAuth({
      provider: "google",
      options: {
        redirectTo: `${window.location.origin}/auth/callback?type=center`,
      },
    })
  }
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                <Label htmlFor="nip">
                  {t("nip")}{" "}
                  <span className="text-xs text-muted-foreground">{t("nipOptional")}</span>
                </Label>
                <Input
                  id="nip"
