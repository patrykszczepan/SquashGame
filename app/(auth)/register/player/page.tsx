    ...
    <div className="flex min-h-svh items-center justify-center p-4">
      <Card className="w-full max-w-md overflow-hidden pt-0">
        <CardHeader className="text-center bg-primary/5 border-b py-8">
          ...
          <CardDescription className="mt-1">Wypełnij swoje dane lub użyj Google</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            >
              <GoogleIcon />
              {googleLoading ? "Przekierowanie..." : "Zarejestruj przez Google"}
            </Button>
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">lub wpisz dane</span>
              </div>
            </div>
