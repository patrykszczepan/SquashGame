...
interface Props {
  ...
  seasonId: string
  defaultPromotions: number
  defaultDemotions: number
}

export function NewLeagueForm({ competitionId, seasonId, defaultPromotions, defaultDemotions }: Props) {
  ...
  const [form, setForm] = useState({
    ...
    promotions: String(defaultPromotions),
    demotions: String(defaultDemotions),
  })
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await createLeague({
      ...
      promotions: parseInt(form.promotions, 10) || 0,
      demotions: parseInt(form.demotions, 10) || 0,
    })
  ...
  return (
    <div className="max-w-lg">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Wartości domyślne zgodne z ustawieniami sezonu.</p>
      </div>
